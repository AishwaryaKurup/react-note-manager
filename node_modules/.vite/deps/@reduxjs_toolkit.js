	...
	return function(storeAPI) {
		return function(next) {
			return function(action) {
				...
				if (!ignoreState) {
					measureUtils.measureTime(function() {
						var foundStateNonSerializableValue = findNonSerializableValue(storeAPI.getState(), "", isSerializable, getEntries, ignoredPaths);
...
function createSlice(options) {
	...
	function buildReducer() {
		...
		return createReducer(initialState, __spreadValues(__spreadValues({}, extraReducers), sliceCaseReducersByType), actionMatchers, defaultCaseReducer);
	}
	var _reducer;
	return {
		name,
