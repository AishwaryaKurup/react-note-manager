...
import { t as require_react_is$1 } from "./react-is-Brv7YZgi.js";
import { t as require_react_dom } from "./react-dom-Bj9W7Dco.js";
import { t as _extends } from "./extends-VVEeICP7.js";
...
function useReduxContext() {
	const contextValue = (0, import_react.useContext)(ReactReduxContext);
...
function createSelectorHook(context = ReactReduxContext) {
	const useReduxContext$2 = context === ReactReduxContext ? useReduxContext : () => (0, import_react.useContext)(context);
	return function useSelector(selector, equalityFn = refEquality) {
		...
		const { store, subscription, getServerState } = useReduxContext$2();
...
function connect(mapStateToProps, mapDispatchToProps, mergeProps, { pure, areStatesEqual = strictEqual, areOwnPropsEqual = shallowEqual, areStatePropsEqual = shallowEqual, areMergedPropsEqual = shallowEqual, forwardRef = false, context = ReactReduxContext } = {}) {
	...
	const wrapWithConnect = (WrappedComponent) => {
		...
		function ConnectFunction(props) {
			const [propsContext, reactReduxForwardedRef, wrapperProps] = (0, import_react.useMemo)(() => {
			...
			const ContextToUse = (0, import_react.useMemo)(() => {
			...
			const contextValue = (0, import_react.useContext)(ContextToUse);
			...
			const childPropsSelector = (0, import_react.useMemo)(() => {
				return finalPropsSelectorFactory(store.dispatch, selectorFactoryOptions);
			}, [store]);
			const [subscription, notifyNestedSubs] = (0, import_react.useMemo)(() => {
			...
			const overriddenContextValue = (0, import_react.useMemo)(() => {
			...
			const lastChildProps = (0, import_react.useRef)();
			const lastWrapperProps = (0, import_react.useRef)(wrapperProps);
			const childPropsFromStoreUpdate = (0, import_react.useRef)();
			const renderIsScheduled = (0, import_react.useRef)(false);
			(0, import_react.useRef)(false);
			const isMounted = (0, import_react.useRef)(false);
			const latestSubscriptionCallbackError = (0, import_react.useRef)();
			...
			const actualChildPropsSelector = (0, import_react.useMemo)(() => {
				const selector = () => {
			...
			const subscribeForReact = (0, import_react.useMemo)(() => {
			...
			const renderedWrappedComponent = (0, import_react.useMemo)(() => {
...
function Provider({ store, context, children, serverState }) {
	...
	const previousState = (0, import_react.useMemo)(() => store.getState(), [store]);
	useIsomorphicLayoutEffect(() => {
...
function createStoreHook(context = ReactReduxContext) {
	const useReduxContext$1 = context === ReactReduxContext ? useReduxContext : () => (0, import_react.useContext)(context);
